...
const DistributionListPage: React.FC = () => {
  ...
  const loadOrders = () => {
    // Показываем заказы со статусом locked, distributed, financial, completed
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Распределение заказов</h2>
              ...
              <tr>
                <td colSpan={6} className="px-6 py-12 text-center">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-500 mb-2">Нет заказов для распределения</p>
                    <p className="text-gray-400 text-sm">Создайте заказ, чтобы начать работу</p>
                  </div>
                </td>
              </tr>
            ) : (
