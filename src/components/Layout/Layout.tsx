...
import { getCurrentUser, setCurrentUser, isAdminMode } from '../../store';
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-700 to-indigo-700 shadow-lg">
        <div className="px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            {adminMode && (
              <div className="ml-4 px-3 py-1 bg-red-500 text-white text-xs font-bold rounded-full animate-pulse">
